...
router.route("/:instituteNumber/category").post(isLoggedIn,
    accessTo(Role.Institute),
    asyncErrorHandler(createCategory))

router.route("/:instituteNumber/category").get(isLoggedIn,
    asyncErrorHandler(getAllCategories))

router.route("/category/:id").get(isLoggedIn,
    asyncErrorHandler(getSingleCategory))

router.route("/:instituteNumber/category/:id").delete(isLoggedIn,
    accessTo(Role.Institute),
    asyncErrorHandler(deleteCategory))

router.route("/:instituteNumber/category/:id").patch(isLoggedIn,
    accessTo(Role.Institute),
